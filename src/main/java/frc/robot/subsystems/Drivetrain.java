...
public class Drivetrain extends SubsystemBase {
  ...
  public void arcadeDrive(double xaxisSpeed, double zaxisRotate) {
    ...
    //m_diffDrive.arcadeDrive(-1*xaxisSpeed, 0.5*zaxisRotate);
  }
  ...
  public double getLeftDistanceMeters() {
    return this.getLeftDistanceInch() * Constants.DriveConstants.INCHES_TO_METERS;
  }

  public double getRightDistanceMeters() {
    return this.getRightDistanceInch() * Constants.DriveConstants.INCHES_TO_METERS;
  }
  ...
  public void periodic() {
    ...
    //System.out.print("Distance per pulse:");
    //System.out.println(m_leftEncoder.getDistancePerPulse());
