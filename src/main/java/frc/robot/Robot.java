...
public class Robot extends TimedRobot {
  ...
  public void autonomousInit() {
    ...
    if (m_autonomousCommand != null) {
      System.out.println("Schedule autonomous");
  ...
  public void autonomousPeriodic() {
    SmartDashboard.putString("/robot/pose",m_robotContainer.getPose().toString());
  ...
  public void teleopPeriodic() {
    SmartDashboard.putString("/robot/pose",m_robotContainer.getPose().toString());
    SmartDashboard.putString("/robot/rotation",m_robotContainer.getPose().getRotation().toString());
